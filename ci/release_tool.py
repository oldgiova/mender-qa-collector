...
def set_component_version_to(dir, component, tag, image_repository=None):
    ...
    if component.type == "docker_image":
        for filename in compose_files_docker:
            ...
            if image_repository:
                _replace_repository_in_file(filename, component.docker_image(), image_repository)
...
def do_set_version_to(args):
    ...
    if version_type == "all":
        ...
        set_component_version_to(integration_dir(), component, args.version, args.repository)
        # Update extra files used in integration tests
        set_component_version_to(
            os.path.join(integration_dir(), "backend-tests", "docker"),
            component,
        ...
        set_component_version_to(
            os.path.join(integration_dir(), "extra", "mtls"), component, args.version, args.repository
        )
        set_component_version_to(
            os.path.join(integration_dir(), "extra", "failover-testing"),
            component,
